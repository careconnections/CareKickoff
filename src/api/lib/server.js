...
var basic_1 = __importDefault(require("@hapi/basic"));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, exports.server.register(basic_1["default"])];
                case 1:
                    _a.sent();
                    exports.server.auth.strategy("simple", "basic", { validate: auth_1.validate });
